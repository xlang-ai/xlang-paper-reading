...
3. **From Pixels to UI Actions: Learning to Follow Instructions via Graphical User Interfaces.** Arxiv
...
4. **Mind2Web: Towards a Generalist Agent for the Web.** Arxiv
...
5. **A Real-World WebAgent with Planning, Long Context Understanding, and Program Synthesis** Arxiv
