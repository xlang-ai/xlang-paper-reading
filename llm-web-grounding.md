...
10. **Multimodal Web Navigation with Instruction-Finetuned Foundation Models.** Arxiv

    *Hiroki Furuta, Ofir Nachum, Kuang-Huei Lee, Yutaka Matsuo, Shixiang Shane Gu, Izzeddin Gur*  [[pdf](https://arxiv.org/abs/2305.11854)], 2023.5

11. **From Pixels to UI Actions: Learning to Follow Instructions via Graphical User Interfaces.** Arxiv
...
12. **Mind2Web: Towards a Generalist Agent for the Web.** Arxiv
...
13. **A Real-World WebAgent with Planning, Long Context Understanding, and Program Synthesis** Arxiv
...
14. **WebArena: A Realistic Web Environment for Building Autonomous Agents** Arxiv
