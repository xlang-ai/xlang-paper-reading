...
- [LLM tool usage](https://github.com/xlang-ai/xlang-paper-reading/blob/main/llm-code-generation.md)
...
92. **Learning to Model the World with Language** Arxiv
